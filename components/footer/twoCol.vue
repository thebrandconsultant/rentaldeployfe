<template>
  ...
  <aside class="hidden lg:relative lg:col-span-2 lg:block">
    <img
      alt="Art"
      src="https://images.unsplash.com/photo-1560185009-5bf9f2849488?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
      class="absolute inset-0 object-cover w-full h-full"
    />
    <img class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-1/3 pt-8" src="/whiteLogo.png" />
  </aside>
